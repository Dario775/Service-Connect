        ...
        <div className="flex items-center justify-between h-16">
          ...
          {currentUser ? (
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={onLogout}
                className="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-slate-700 bg-slate-100 hover:bg-slate-200 dark:text-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600"
              >
                <LogoutIcon className="h-5 w-5 mr-2 -ml-1" />
